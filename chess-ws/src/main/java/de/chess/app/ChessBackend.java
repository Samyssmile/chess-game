...
public class ChessBackend implements IChessBackend {
    ...
    public void start() throws IOException, ClassNotFoundException {
        IRequestAnalyzer requestAnalyzer = new RequestAnalyzer();
        Thread gameServerThread = new GameServer(serverProperties.getServerPort(), serverProperties.getBacklogLimit(), serverProperties.getLocalHostAddress(), requestAnalyzer);
